	...
	public function render_help_tab() {
		$content = '<p>' .
				...
				'<p>' .
					...
					sprintf(
						__( 'Check the <a target="_blank" href="%s">documentation about the View Logs screen</a> for more details.', 'email-log' ),
				...
				'<p>' .
					sprintf(
						__( 'You can perform advanced actions like re-sending email, automatically forwarding emails or export logs with our <a target="_blank" href="%s">premium plugins</a>.', 'email-log' ),
		...
		$this->get_screen()->set_help_sidebar(
			...
			'<p><a target="_blank" href = "https://wpemaillog.com/docs/?utm_campaign=Upsell&utm_medium=wpadmin&utm_source=help&utm_content=docs">' . __( 'Documentation', 'email-log' ) . '</a></p>' .
			'<p><a target="_blank" href = "https://wpemaillog.com/support/?utm_campaign=Upsell&utm_medium=wpadmin&utm_source=help&utm_content=support">' . __( 'Support', 'email-log' ) . '</a></p>' .
			'<p><a target="_blank" href = "https://wpemaillog.com/store/?utm_campaign=Upsell&utm_medium=wpadmin&utm_source=help&utm_content=store">' . __( 'Add-ons', 'email-log' ) . '</a></p>'
		);
	}
